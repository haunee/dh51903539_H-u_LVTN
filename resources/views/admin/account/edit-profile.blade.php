                                        ...
                                        <div class="col-md-12">
                                            <div class="profile-img-edit">
                                                <div class="crm-profile-img-edit">
                                                    ...
                                                    <img class="crm-profile-pic rounded-circle avatar-100 replace-avt" src="/storage/kidadmin/images/user/<?php echo Session::get('Avatar')?>" alt="profile-pic">  
                                                    @else
                                                        <img class="crm-profile-pic rounded-circle avatar-100 replace-avt" src="/kidadmin/images/user/12.jpg" alt="profile-pic">
                                                    @endif
