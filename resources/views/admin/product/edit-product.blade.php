                        ...
                        <div class="row">
                            <div class="col-md-12">                      
                                <div class="form-group">
                                    ...
                                    <input id="ProductName" name="ProductName" type="text" class="form-control slug" value="{{$product->ProductName}}" placeholder="Vui lòng nhập tên" data-errors="Please Enter Name." required>
                            ...
                            <div class="col-md-12 d-flex flex-wrap input-attrs">
                                ...
                                <div id="input-attrs-item-{{$pd_attr->idAttriValue}}" class="col-md-12 d-flex flex-wrap input_attrs_items">
                                    <div class="col-md-6">
                                        <input class="form-control text-center" type="text" value="{{$pd_attr->AttriValName}}" disabled>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <input id="qty-attr-{{$pd_attr->idAttriValue}}" value="{{$pd_attr->Quantity}}" class="form-control text-center qty-attr" name="qty_attr[]" type="number" placeholder="Nhập số lượng phân loại">
                                    </div>
                                </div>
                                @endforeach
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex flex-wrap" id="image-list">
                                        ...
                                        <div id="image-item-{{$key}}" class="image-item">
                                            <img src="{{asset('/storage/kidadmin/images/product/'.$image)}}" class="img-fluid rounded avatar-100 mr-3 mt-2">
