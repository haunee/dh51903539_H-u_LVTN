                ...
                <div class="table-responsive rounded mb-3">
                    <table class="data-tables table mb-0 tbl-server-info">
                        ...
                        <tbody class="ligth-body" id="load-attribute">
                                ...
                                <td>
                                    <div class="d-flex align-items-center list-action">
                                        <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Sửa"
                                            href="{{URL::to('/edit-attribute/'.$attribute->idAttribute)}}"><i class="fas fa-edit mr-0"></i></a>
                            ...
                            <div class="modal fade bd-example-modal-sm"  role="dialog" id="model-delete-{{$attribute->idAttribute}}"  aria-hidden="true">
