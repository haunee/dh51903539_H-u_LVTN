            ...
            <div class="col-lg-6 col-md-8">
                <div class="shop-image">
                    <div class="shop-single-preview-image">
                        <img class="product-zoom" src="{{asset('/storage/kidadmin/images/product/'.$image)}}" alt="">
                    ...
                    <div id="gallery_01" class="shop-single-thumb-image shop-thumb-active swiper-container">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide single-product-thumb">
                                <a class="active" href="#" data-image="{{asset('/storage/kidadmin/images/product/'.$img)}}">
                                    <img src="{{asset('/storage/kidadmin/images/product/'.$img)}}" alt="">
                                </a>
                            </div>
                            @endforeach
                        </div>
                ...
                <div class="shop-single-content">
                        ...
                        <ul class="material-list">
                            ...
                            <li>
                                <div class="material-radio">
                                    <input type="radio" value="{{$pd_attr->idProAttr}}" class="AttriValName" name="material" id="{{$pd_attr->idProAttr}}" data-name="{{$pd_attr->AttriValName}}" data-qty="{{$pd_attr->Quantity}}">
                    ...
                    <div class="custom-payment-options">
                        ...
                        <ul class="payment-options">
                            <li><img src="{{asset('/page/images/payment-icon/payment-1.svg')}}" alt=""></li>
                            <li><img src="{{asset('/page/images/payment-icon/payment-2.svg')}}" alt=""></li>
                            <li><img src="{{asset('/page/images/payment-icon/payment-3.svg')}}" alt=""></li>
                            <li><img src="{{asset('/page/images/payment-icon/payment-4.svg')}}" alt=""></li>
                            <li><img src="{{asset('/page/images/payment-icon/payment-5.svg')}}" alt=""></li>
                            <li><img src="{{asset('/page/images/payment-icon/payment-7.svg')}}" alt=""></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="single-product">
                            <div class="product-image">
                                ...
                                <a href="{{URL::to('/shop-single/'.$related_product->idProduct)}}">
                                    <img src="{{asset('/storage/kidadmin/images/product/'.$image)}}" alt="">
                                </a>
                            ...
                            <div class="product-content text-center">
                                ...
                                <h4 class="product-name"><a href="{{URL::to('/shop-single/'.$related_product->idProduct)}}">{{$related_product->ProductName}}</a></h4>
                                <div class="price-box">
