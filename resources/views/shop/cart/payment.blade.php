        ...
        <div class="container__address">
            ...
            <div class="container__address-content">
                <div class="container__address-content-hd justify-content-between">
                    <div><i class="container__address-content-hd-icon fa fa-map-marker"></i>Thông Tin Địa Chỉ Nhận Hàng</div>
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#AddressModal">+ Thêm Thông Tin/Địa Chỉ</button>
                </div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr class="product-item">
                        ...
                        <td class="image">
                            <a href="{{URL::to('/shop-single/'.$pd_cart->idProduct)}}"><img src="{{asset('/storage/kidadmin/images/product/'.$image)}}" alt=""></a>
                        </td>
                        <td class="product">
                            <a href="{{URL::to('/shop-single/'.$pd_cart->idProduct)}}">{{$pd_cart->ProductName}}</a>
