                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="single-product">
                                    ...
                                    <div class="product-content text-center">
                                        ...
                                        <h4 class="product-name"><a href="{{URL::to('/shop-single/'.$pd->idProduct)}}">{{$pd->ProductName}}</a></h4>
                                        <div class="price-box">
                                            <span
                    ...
                    <div class="sidebar-categories">
                        ...
                        <ul class="categories-list">
                            ...
                            <li class="d-flex align-items-center">
                                ...
                                <span style="margin-left:auto">({{App\Http\Controllers\ProductController::count_cat_search($category->idCategory)}})</span>
                            </li>
                            @endforeach
                        </ul>
                    </div>
